...
The table above and both plots below come from a single run of `train.py` and are reproducible from this commit. The table is regenerated by `update_readme.py`; the plots are overwritten by the training run itself.
